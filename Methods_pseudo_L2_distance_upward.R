...
save(R2DA, file = "R2DA_pL2_goup.RData")
...
save(R2, file = "R2_pL2_goup.RData")
...
rmse_goup_pL2 = c(rmse_bmax, rmse_bsum, rmse_DA, rmse_rf)
save(rmse_goup_pL2, file = "rmse_goup_pL2.RData")
mae_goup_pL2 = c(mae_bmax, mae_bsum, mae_DA, mae_rf)
save(mae_goup_pL2, file = "mae_goup_pL2.RData")
