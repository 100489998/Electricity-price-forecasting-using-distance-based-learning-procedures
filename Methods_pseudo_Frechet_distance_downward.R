#############################################################################################
# Training and testing the methods (Pseudo-Fréchet distance and downward secondary market)
#############################################################################################
...
save(R2DA, file = "R2DA_pf_godown.RData")
...
save(R2, file = "R2_pf_godown.RData")
...
(min = round(min(error_DA_means, error_rf_means, error_knn_max_means, error_knn_sum_means)))
(max = round(max(error_DA_means, error_rf_means, error_knn_max_means, error_knn_sum_means)))
min = 1
max = 45
...
rmse_godown_pf = c(rmse_bmax, rmse_bsum, rmse_DA, rmse_rf)
save(rmse_godown_pf, file = "rmse_godown_pf.RData")
mae_godown_pf = c(mae_bmax, mae_bsum, mae_DA, mae_rf)
save(mae_godown_pf, file = "mae_godown_pf.RData")
